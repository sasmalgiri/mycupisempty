...
export async function middleware(request: NextRequest) {
  ...
  const studentRoutes = [
    ...
    '/companions', '/circles', '/onboarding', '/interleave', '/arena', '/wonder', '/tricks', '/blogs', '/league', '/magic-notes', '/scan', '/persona', '/courses', '/admin', '/mock-test', '/past-papers', '/topper-routine', '/handwriting', '/spelling', '/school-papers',
  ];
